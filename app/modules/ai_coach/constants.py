...
PHASE1_RULES: Dict[int, Dict[str, Any]] = {
    ...
    2: {
        "key": "importance",
        "question": "อะไรทำให้คุณอยากหยิบเรื่องนี้มาโค้ชในวันนี้?",
        "goal": "เข้าใจเหตุผลหรือความสำคัญที่ทำให้ผู้ใช้เลือกหัวข้อนี้มาโค้ช",
        "required": ["reason"],
        "answer_type": "reason",
        "step_prompt_hint": "ถามหาเหตุผลหรือความสำคัญของหัวข้อนี้กับผู้ใช้ ห้ามถามผลลัพธ์ในอนาคตหรือวิธีแก้",
    },
    3: {
        "key": "current_feeling",
        ...
        "answer_type": "emotion",
        "step_prompt_hint": (
        "step นี้ต้องการเข้าใจความรู้สึก ความคิด หรือท่าทีปัจจุบันของผู้ใช้ต่อเรื่องนี้ "
        "ให้ชวนผู้ใช้สะท้อนความรู้สึกหรือสิ่งที่อยู่ในใจตอนนี้ "
        "ไม่ใช่ถามหาเป้าหมาย วิธีแก้ หรือผลลัพธ์ในอนาคต "
        "ถ้าผู้ใช้บอกความรู้สึกชัดเจนแล้ว ถือว่าเพียงพอได้แม้คำตอบจะไม่ยาว"
    ),
    },
}
